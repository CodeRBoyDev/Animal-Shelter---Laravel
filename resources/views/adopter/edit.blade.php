                                            ...
                                            <div class="modal-dialog" style="width:450px !important;">
                                              ...
                                              <div style="background-color: #ece0d1" class="modal-content">
                                                <div class="modal-header">
                                                  <h4 class="modal-title" style="margin-left:30%"><i class="fa fa-plus"> Edit adopter</i></h4>
                                                        ...
                                                        <div class="row">
                                                          <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                {!! Form::text('adopter_name',$adopter->adopter_name,array('autofocus required','size'=>'40','class'=>'form-control')) !!}
                                                          ...
                                                          <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                {!! Form::text('adopter_age',$adopter->adopter_age,array('autofocus required','size'=>'40','class'=>'form-control')) !!}
                                                          ...
                                                          <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                {!! Form::text('adopter_phone',$adopter->adopter_phone,array('autofocus required','size'=>'40','class'=>'form-control')) !!}
                                                          ...
                                                          <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                {!! Form::text('adopter_address',$adopter->adopter_address,array('autofocus required','size'=>'40','class'=>'form-control')) !!}
